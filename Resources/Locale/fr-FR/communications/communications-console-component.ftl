...
comms-console-menu-announcement-button-tooltip = Envoyez votre message comme une annonce radio à l'échelle de la station.  
comms-console-menu-broadcast-button = Diffuser  
comms-console-menu-broadcast-button-tooltip = Diffusez votre message sur les écrans muraux de la station. Remarque : Ils ne peuvent contenir que dix caractères !  
comms-console-menu-alert-level-button-tooltip = Modifiez le niveau d'alerte de la station. S'applique immédiatement après sélection.  
...
comms-console-menu-emergency-shuttle-button-tooltip = Appelle ou rappelle la navette d'urgence. Vous ne pouvez la rappeler que s'il reste suffisamment de temps.  
...
comms-console-message-too-long = Le message est trop long  
